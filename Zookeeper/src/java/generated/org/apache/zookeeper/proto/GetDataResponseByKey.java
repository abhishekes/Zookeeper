...
public class GetDataResponseByKey implements Record {
  private byte[] data;
  
  public GetDataResponseByKey() {
  }
  public GetDataResponseByKey(
        byte[] data) {
    this.data=data;
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    if (!(peer_ instanceof GetDataResponseByKey)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    GetDataResponseByKey peer = (GetDataResponseByKey) peer_;
    int ret = 0;
    {
      byte[] my = data;
      byte[] ur = peer.data;
